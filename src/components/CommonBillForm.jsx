            ...
            <div className="flex flex-col gap-y-1 border-l-2 border-blue-100">
              {column.map((field) => (
                <div className="flex flex-row" key={field.name}>
                  ...
                  {field.type === "select" ? (
                    <select name={field.name} id={field.name} className="border ms-auto w-7/12">
                    ...
                    <textarea name={field.name} id={field.name} autoComplete="given-name" className="border ml-3 ms-auto w-7/12 resize-none" />
                  ) : (
                    <input type={field.type} name={field.name} id={field.name} autoComplete="given-name" className="border ms-auto w-7/12" />
                  )}
                </div>
              ))}
            </div>
            ...
            <tbody className="text-right ">
              {rows.map((item, index) => (
                <tr key={index} className="bg-white hover:bg-gray-50">
                  ...
                  <td className="text-left">
                    <input type="text" name="description" id="description" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="qty" id="qty" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="rate" id="rate" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="discount" id="discount" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="taxableValue" id="taxableValue" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="cgst" id="cgst" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="sgst" id="sgst" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="igst" id="igst" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                  <td className="">
                    <input type="number" name="total" id="total" autoComplete="given-name" className="border ms-auto w-full" />
                  </td>
                </tr>
              ))}
            </tbody>
          ...
          <div className="flex flex-row gap-x-10 mx-2">
            <div className="flex flex-col w-9/12 gap-y-6 mt-3">
              <div className="flex flex-row">
                ...
                <textarea name="remarks" id="remarks" autoComplete="given-name" className="border ml-3 w-10/12 resize-none h-12" />
              </div>

              <div className="flex flex-row">
                <label className="w-2/12  font-medium text-gray-700">Terms & Conditions</label>
                <textarea name="terms" id="terms" autoComplete="given-name" className="border ml-3 w-10/12 resize-none h-12" />
              </div>
            </div>
            ...
            <div className="flex flex-col w-3/12 gap-y-1">
              <div className="flex flex-row">
                ...
                <input type="text" name="subTotal" id="subTotal" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>

              <div className="flex flex-row">
                <label className=" font-medium text-gray-700">Discount</label>
                <input type="text" name="discount" id="discount" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>

              <div className="flex flex-row">
                <label className=" font-medium text-gray-700">Taxable Value</label>
                <input type="text" name="taxableValue" id="taxableValue" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>

              <div className="flex flex-row">
                <label className=" font-medium text-gray-700">CGST</label>
                <input type="text" name="cgst" id="cgst" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>

              <div className="flex flex-row">
                <label className=" font-medium text-gray-700">SGST</label>
                <input type="text" name="sgst" id="sgst" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>

              <div className="flex flex-row">
                <label className=" font-medium text-gray-700">IGST</label>
                <input type="text" name="igst" id="igst" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>

              <div className="flex flex-row">
                <label className=" font-medium text-gray-700">Total</label>
                <input type="text" name="total" id="total" autoComplete="given-name" className="border ms-auto w-6/12 text-right h-5  pr-2" />
              </div>
            </div>
          </div>
