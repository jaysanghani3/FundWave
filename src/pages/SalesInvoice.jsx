      ...
      <div className="flex flex-col border-2 gap-y-3 min-h-full text-xs">
        ...
        <div className="grid grid-cols-3 gap-6 border p-2  mx-2">
          <div className="flex flex-col gap-y-1">
            ...
            <div className="flex flex-row">
              <label className=" font-medium text-gray-700">GST No</label>
          ...
          <div className="flex flex-col gap-y-1">
            <div className="flex flex-row">
              <label className=" font-medium text-gray-700">Cash/Credit</label>
              <select name="cashCredit" id="cashCredit" className="border ms-auto w-7/12">
        ...
        <div className="overflow-x-auto border mx-2">
          ...
          <div className="flex flex-row justify-end gap-x-2 m-2">
            <button className="bg-[#1d5e7e] text-white px-3 py-1 " onClick={addRow}>Add Item</button>
          </div>
        </div>
