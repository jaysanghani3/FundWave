...
const PurchaseBill = () => {
  ...
  useEffect(() => {
    // Update purchase totals whenever rows change
  ...
  const handleItemChange = (e, rowIndex, field) => {
    ...
    updatedPurchaseItems[rowIndex] = { ...updatedItem };
  ...
  const addRow = () => {
    ...
    setPurchase((prevPurchase) => ({
      ...prevPurchase,
      items: [...prevPurchase.items, { ...initialItem }],
    }));
  };
      ...
      <div className="grid grid-cols-3 gap-6 border border-gray-300 p-2 mx-2">
        ...
        <div className="flex flex-col gap-y-1 border-l-2 border-blue-100">
          <div className="flex flex-row">
            ...
            <input autoComplete="off" value={purchase.gst} onChange={handlePurchaseChange} type="text" name="gst" id="gst" className="border ps-2 border-gray-300 ms-auto w-7/12" />
          </div>
        ...
        <div className="flex flex-col gap-y-1 border-l-2 border-blue-100">
          <div className="flex flex-row">
            ...
            <input autoComplete="off" value={purchase.contactNumber} onChange={handlePurchaseChange} type="number" name="contactNumber" id="contactNumber" className="border ps-2 border-gray-300 ms-auto w-7/12" />
          </div>

          <div className="flex flex-row">
            <label className="ml-5 font-medium text-gray-700">Address</label>
            <textarea autoComplete="off" value={purchase.billingAddress} onChange={handlePurchaseChange} name="billingAddress" id="billingAddress" className="border ps-2 border-gray-300 ms-auto w-7/12 resize-none h-12" />
          </  div>
        </div>
      </div>
            ...
            <table className="table-auto w-full bg-transparent">
              <tbody className="text-right ">
                ...
                <tr>
                  ...
                  <td>
                    <span>{(purchase.subTotal - purchase.discount).toFixed(2)}</span>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td>
                    <span className="font-semibold text-lg">{(purchase.total).toFixed(2)}</span>
                  </td>
                </tr>
              </tbody>
            </table>
