...
const MasterTableview = ({ title, tableHeader, tableBody, getCustomerData, getItemData, getVendorData, getInvoiceData }) => {
  ...
  const handleDeleteVC = async (id) => {
    if (title === "Customer") {
      if (window.confirm("Are you sure you want to delete this customer?")) {
        try {
          await axios.delete(`https://fundwave-api.vercel.app/customer/${id}`);
      ...
      if (window.confirm("Are you sure you want to delete this vendor?")) {
        try {
          await axios.delete(`https://fundwave-api.vercel.app/vendor/${id}`);
  ...
  const handleDeleteItem = async (id) => {
    if (window.confirm("Are you sure you want to delete this Item?")) {
      try {
        await axios.delete(`https://fundwave-api.vercel.app/item/${id}`);
  ...
  const handleDeleteInvoice = async (id) => {
    if (window.confirm("Are you sure you want to delete this Item?")) {
      try {
        await axios.delete(`https://fundwave-api.vercel.app/invoice/${id}`);
        deleteToast();
        getInvoiceData();
      } catch (error) {
        console.error('Error deleting item:', error);
  ...
  const handleDeletePurchase = async (id) => {
    if (window.confirm("Are you sure you want to delete this Item?")) {
      try {
        await axios.delete(`https://fundwave-api.vercel.app/purchase/${id}`);
        deleteToast();
        getInvoiceData();
      } catch (error) {
        console.error('Error deleting item:', error);
